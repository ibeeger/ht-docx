 ...
 * @Last Modified time: 2016-09-01 11:24:37
 */
...
Docx.prototype.toFile = function(name, callback) {
	...
	this.toPath = arguments.length>1? __dirname+"/"+name : __dirname+"/"+tmpname+".docx";
	console.log(this.toPath)
	let _this = this;
	if (this.path) {
		_this.exec(tmpname,function(res) {
			_callback(res,"/tmp/"+tmpname+".docx");
		})
	} else {
